package com.kirayepay.KirayePay_Rikki.Network;


import com.kirayepay.KirayePay_Rikki.Network.Responses.AdsContainments;
import com.kirayepay.KirayePay_Rikki.Network.Responses.AdsResponse;
...
import com.kirayepay.KirayePay_Rikki.Network.Responses.EmailRegisterResponse;
import com.kirayepay.KirayePay_Rikki.Network.Responses.PostContainments;
import com.kirayepay.KirayePay_Rikki.Network.Responses.RequirementContainments;
import com.kirayepay.KirayePay_Rikki.Network.Responses.SellerProfileResponse.ProfileContainment;
...
public interface ApiInterface
{
    ...
    Call<PostContainments> postAds(@Part("userid") RequestBody userid, @Part("title") RequestBody title, @Part("description") RequestBody description,
    ...
    @Multipart
    @POST("ads?api_token=VZE6G37Kx8S1n7fnQBaSsK8cAu6zyF5h1aV8OznB9gofAt9iJYoeOs3aLfHz")
    Call<PostContainments> postAdsWithImage(@Part("userid") RequestBody userid, @Part("title") RequestBody title, @Part("description") RequestBody description,
                                            @Part("parent_category") RequestBody parent_category, @Part("sub_category") RequestBody sub_category, @Part("category") RequestBody category,@Part("manufacture") RequestBody manufacture, @Part("availability") RequestBody availability,
